...
public class labOne {
	...
	public static void main(String[] args) {
		...
		while (cont == 'y') {
			...
			/*
			 * Q: had an error when I used a string enter initially i.e.: String input =
			 * scnr.nextLine(); cont = input.charAt(0); why is this the case as opposed to
			 * how i did it below which returns no errors.
			 */
